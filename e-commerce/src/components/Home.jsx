      ...
      <div>
        ...
        <div className="md:p-16 p-8">
          ...
          <p className="text-center mx-auto text-gray-600 md:w-7/12 mt-2 mb-16">
            ...
            accusantium iusto, consequatur, officiis sapiente iure nisi
            aspernatur est corporis dolor ratione adipisci
          </p>
            ...
            {products.map((item, index) => (
              <div key={index} className="bg-white shadow-lg border">
                ...
                <div className="p-4">
                  ...
                  <button className="bg-rose-500 py-2 w-full rounded text-white font-semibold mt-4">
