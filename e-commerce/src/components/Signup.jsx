  ...
  return (
    <div className="grid grid-cols-2 h-screen overflow-hidden">
      ...
      <div className="flex flex-col justify-center">
        <h1 className="text-4xl font-bold ml-4">Create New User</h1>
        <p className="text-lg text-gray-600 ml-4">
         Enter account details to signup 
        </p>
        <form>
          <div className="flex flex-col">
            <label className="font-semibold text-lg mb-1 ml-4">Fullname</label>
            <input
              required
              type="text"
              placeholder="Rahul"
          ...
          <div className="flex flex-col relative">
            ...
            <button className="py-3 px-8 rounded bg-blue-600 text-white font-semibold hover:bg-rose-600 w-fit ml-4">Signup</button>
          </div>
        </form>
      </div>
    </div>
